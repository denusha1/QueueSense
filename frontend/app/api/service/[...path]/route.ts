...
const allow=/^(departments|staff(?:\/[a-f0-9-]+\/(?:availability|call-next))?|schedules|queue\/(?:live|check-in|[a-f0-9-]+\/(?:status|close))|analytics\/summary|simulation\/staffing|models\/performance|predict\/wait-time|alerts(?:\/(?:refresh|[a-f0-9-]+\/resolve))?|admin\/(?:users(?:\/[a-f0-9-]+)?|departments(?:\/[a-f0-9-]+)?|staff(?:\/[a-f0-9-]+\/schedule)?)|audit|data\/import|reports\/export|patient\/[A-Za-z0-9_-]{30,80})$/;
